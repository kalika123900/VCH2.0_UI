...
class Step3 extends React.Component {
  state = {
    ...
    category: '',
    customDemographic: '',
    keyword: [{ value: "Machine Learning", label: "Machine Learning" }],
    customKeyword: '',
    customUniversity: '',
    university: [
      { id: 1, status: true, value: 'oxford', label: 'Oxford' },
      { id: 2, status: false, value: 'rgpv', label: 'RGPV ' },
      { id: 3, status: true, value: 'ips', label: 'IPS' },
      { id: 4, status: false, value: 'iiit', label: 'IIIT University' },
    ],
    demographic: [
      { id: 1, status: false, value: 'no-preference', label: 'No preference' },
      { id: 2, status: true, value: 'women', label: 'Women ' },
      { id: 3, status: true, value: 'men', label: 'Men' },
