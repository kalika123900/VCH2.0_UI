...
const styles = theme => ({
  appBar: {
    ...
    '& $menuButton': {
      color: theme.palette.type === 'dark' ? theme.palette.primary.light : theme.palette.primary.light,
  ...
  opened: {
    color: theme.palette.type === 'dark' ? theme.palette.primary.main : '#fafafa',
    boxShadow: `inset 0 0 0 1px ${theme.palette.primary.main}`,
    '& svg': {
      fill: theme.palette.type === 'dark' ? theme.palette.primary.main : '#fafafa',
    }
  },
  rightIcon: {
  ...
  selected: {
    background: theme.palette.type === 'dark' ? theme.palette.primary.main : theme.palette.secondary.main,
  ...
  dropDownMenu: {
    background: theme.palette.type === 'dark' ? '' : theme.palette.primary.main,
    color: theme.palette.type === 'dark' ? '' : theme.palette.primary.light,
    minWidth: 200,
