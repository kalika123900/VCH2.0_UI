...
class EmailList extends React.Component {
  ...
  render() {
    ...
    const getEmail = (dataArray, type) => dataArray.map(mail => {
    ...
    const showEmail = category => {
      switch (category) {
        case 'inbox':
          return getEmail(inbox, 'inbox');
        case 'stared':
          return getEmail(stared, 'stared');
        case 'sent':
          return getEmail(sent, 'sent');
        case 'campaign':
          return getEmail(campaign, 'campaign');
        case 'bulkemail':
          return getEmail(bulkemail, 'bulkemail');
        default:
          return getEmail(inbox, 'inbox');
      }
    };
