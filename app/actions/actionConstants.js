...
export const STORE_SKILL_INTERESTS_INIT = 'STORE_SKILL_INTERESTS_INIT';
export const STORE_EDUCATION_DATA_INIT = 'STORE_EDUCATION_DATA_INIT';
export const STORE_EXPERIENCE_INIT = 'STORE_EXPERIENCE_INIT';
